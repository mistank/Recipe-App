...
var i_14415 = (0);
while(true){
if((i_14415 < arr.length)){
(arr[i_14415] = null);

var G__14416 = (i_14415 + (1));
i_14415 = G__14416;
continue;
} else {
}
...
var i_14428 = (self__.level + (1));
while(true){
if((i_14428 <= (new_level + (1)))){
(update[i_14428] = self__.header);

var G__14429 = (i_14428 + (1));
i_14428 = G__14429;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_14430 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_14430[i]));
} else {
x__$2.forward.push((((i < links_14430.length))?(links_14430[i]):null));
}

if((i < links_14430.length)){
(links_14430[i] = x__$2);
} else {
links_14430.push(x__$2);
}
...
var i_14432 = (0);
while(true){
if((i_14432 <= self__.level)){
var links_14433 = (update[i_14432]).forward;
if((x__$1 === (((i_14432 < links_14433.length))?(links_14433[i_14432]):null))){
(links_14433[i_14432] = (x__$1.forward[i_14432]));

var G__14434 = (i_14432 + (1));
i_14432 = G__14434;
continue;
} else {
...
var G__14442 = nx;
var G__14443 = (level__$1 - (1));
x = G__14442;
level__$1 = G__14443;
continue;
} else {
var G__14444 = x;
var G__14445 = (level__$1 - (1));
x = G__14444;
level__$1 = G__14445;
continue;
}
