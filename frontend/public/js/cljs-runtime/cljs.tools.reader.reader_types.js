...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_22130 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_22130(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_22131 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_22131(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_22132 = (function (reader,ch){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_22132(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_22133 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_22133(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_22134 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_22134(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_22135 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_22135(reader);
}
});
...
var G__22139 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null, );
var G__22140 = s.append(c);
c = G__22139;
s = G__22140;
continue;
}
