...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_14575 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_14575(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_14580 = (function (runtime,key,spec){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_14580(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_14581 = (function (runtime,key){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_14581(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_14585 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_14585(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_14586 = (function (runtime,input,callback){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_14586(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_14591 = (function (runtime,code){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_14591(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__14568,callback){
var map__14570 = p__14568;
var map__14570__$1 = cljs.core.__destructure_map(map__14570);
var input = map__14570__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14570__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14570__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
