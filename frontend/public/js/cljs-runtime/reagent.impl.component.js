...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__21828 = c;
var G__21828__$1 = (((G__21828 == null))?null:G__21828.prototype);
if((G__21828__$1 == null)){
return null;
} else {
return G__21828__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__21829 = c;
var G__21829__$1 = (((G__21829 == null))?null:G__21829.prototype);
if((G__21829__$1 == null)){
return null;
} else {
return G__21829__$1.render;
}
})() == null)))));
});
...
while (G__21924__i < G__21924__a.length) {G__21924__a[G__21924__i] = arguments[G__21924__i + 0]; ++G__21924__i;}
  args = new cljs.core.IndexedSeq(G__21924__a,0,null);
} 
...
var or__5002__auto__ = (function (){var G__21837 = c;
var G__21837__$1 = (((G__21837 == null))?null:G__21837.constructor);
if((G__21837__$1 == null)){
return null;
} else {
return G__21837__$1.displayName;
}
})();
...
var G__21839 = c;
var G__21839__$1 = (((G__21839 == null))?null:G__21839.constructor);
if((G__21839__$1 == null)){
return null;
} else {
return G__21839__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__21842 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__21843 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__21843);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__21842);
}});
...
return (function reagent$impl$component$custom_wrapper_$_getDerivedStateFromProps(props,state__$1){
...
var c = this;
var G__21913_21929 = reagent.impl.component.goog$module$goog$object.get(c,"cljsRatom");
if((G__21913_21929 == null)){
} else {
reagent.ratom.dispose_BANG_(G__21913_21929);
}
...
var renders_21930 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_21931 = cljs.core.first(cljs.core.vals(renders_21930));
...
if((cljs.core.count(renders_21930) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_21930))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_21931)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_21931], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__21914 = o;
reagent.impl.component.goog$module$goog$object.set(G__21914,cljs.core.name(k),v);
...
var _STAR_current_component_STAR__orig_val__21915 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__21916 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__21916);

try{return reagent.impl.component.functional_wrap_render(compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__21915);
}});
...
var vec__21917 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21917,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21917,(1),null);
...
var G__21920 = reagent.impl.component.goog$module$goog$object.get(reagent_state,"cljsRatom");
if((G__21920 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__21920);
}
});
}),[]);
