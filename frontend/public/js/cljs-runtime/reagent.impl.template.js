...
var G__21944 = o;
reagent.impl.template.goog$module$goog$object.set(G__21944,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null, v)));
...
while (G__21973__i < G__21973__a.length) {G__21973__a[G__21973__i] = arguments[G__21973__i + 0]; ++G__21973__i;}
  args = new cljs.core.IndexedSeq(G__21973__a,0,null);
} 
...
var G__21945 = o;
reagent.impl.template.goog$module$goog$object.set(G__21945,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
while (G__21976__i < G__21976__a.length) {G__21976__a[G__21976__i] = arguments[G__21976__i + 0]; ++G__21976__i;}
  args = new cljs.core.IndexedSeq(G__21976__a,0,null);
} 
...
var G__21946 = props;
var G__21946__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__21946,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__21946);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__21946__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5002__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__21947 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__21947,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__21947;
}
})(),id_class);
...
var G__21948 = (cljs.core.count(argv) - first_child);
switch (G__21948) {
case (0):
...
var vec__21949 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21949,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21949,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21949,(2),null);
...
var temp__5808__auto___21983 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___21983 == null)){
} else {
var key_21984 = temp__5808__auto___21983;
(jsprops.key = key_21984);
}
...
var temp__5808__auto___21985 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___21985 == null)){
} else {
var key_21986 = temp__5808__auto___21985;
(jsprops.key = key_21986);
}
...
var temp__5808__auto___21987 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___21987 == null)){
} else {
var key_21988 = temp__5808__auto___21987;
(jsprops.key = key_21988);
}
...
var temp__5808__auto___21989 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___21989 == null)){
} else {
var key_21990 = temp__5808__auto___21989;
(jsprops.key = key_21990);
}
...
var temp__5808__auto___21991 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___21991 == null)){
} else {
var key_21993 = temp__5808__auto___21991;
(jsprops.key = key_21993);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__21952_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__21952_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__21953 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21953,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21953,(1),null);
...
break;
default:
var G__21995 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__21996 = compiler;
v = G__21995;
compiler = G__21996;
continue;
...
var G__21957 = tag;
var G__21957__$1 = (((G__21957 instanceof cljs.core.Keyword))?G__21957.fqn:null);
switch (G__21957__$1) {
case ">":
...
*/
reagent.impl.template.t_reagent$impl$template21959 = (function (opts,id,fn_to_element,parse_fn,meta21960){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template21959.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_21961,meta21960__$1){
var self__ = this;
var _21961__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template21959(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta21960__$1));
}));

(reagent.impl.template.t_reagent$impl$template21959.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_21961){
var self__ = this;
var _21961__$1 = this;
return self__.meta21960;
}));

(reagent.impl.template.t_reagent$impl$template21959.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template21959.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template21959.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template21959.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template21959.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template21959.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta21960","meta21960",1952157092,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template21959.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template21959.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template21959");

(reagent.impl.template.t_reagent$impl$template21959.cljs$lang$ctorPrWriter = (function (this__5287__auto__,writer__5288__auto__,opt__5289__auto__){
return cljs.core._write(writer__5288__auto__,"reagent.impl.template/t_reagent$impl$template21959");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template21959.
 */
reagent.impl.template.__GT_t_reagent$impl$template21959 = (function reagent$impl$template$__GT_t_reagent$impl$template21959(opts,id,fn_to_element,parse_fn,meta21960){
return (new reagent.impl.template.t_reagent$impl$template21959(opts,id,fn_to_element,parse_fn,meta21960));
});
...
return (new reagent.impl.template.t_reagent$impl$template21959(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
